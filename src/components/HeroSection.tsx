...
const HeroSection = () => {
  return (
    <section className="relative pt-40 items-center">
      {/* first section */}
      <div className="container  max-h-[60vh] h-[80vh] flex items-center justify-center">
        {/* left section */}
        <div className="relative z-10 text-center mt-32 items-center flex flex-col max-w-xl">
          <h1 className="whisper-regular text-4xl sm:text-5xl md:text-6xl lg:text-7xl pb-4 text-white">Sunita Ramrakhyani</h1>
          <h2 className='text-3xl sm:text-4xl md:text-3xl lg:text-4xl font-bold  mb-8 sm:mb-8 md:mb-8 max-w-2xl leading-tight font-serif text-white'>
          ...
          <p className=' mb-8 sm:mb-8 md:mb-8  font-thin text-[#e9dcd5] text-[18px]'>
        ...
        {/* right section */}
        <div className="mt-40 m-2 content-center flex items-center justify-center ">
          <img src={herobg} alt="" className=" h-[70vh] object-cover z-40" />
        </div>
      </div>
      ...
      <section className="relative w-full z-[120] h-full container pb-12">

        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 px-10 z-10">

          {/* LEFT – Image Collage */}
          <div className="relative flex justify-center h-full ">

            {/* Top image */}
            <div className="absolute -top-36 left-1 shadow-[0_9px_13px_rgba(0,0,0,0.7)] z-50 w-[380px]">
              <img
                src={thirdsection1st}
                alt="Workshop"
            ...
            {/* Bottom image */}
            <div className="absolute bottom-6 left-48 w-[380px] shadow-[0_9px_13px_rgba(0,0,0,0.7)] z-50">
              <img
                src={thirdsection2nd}
