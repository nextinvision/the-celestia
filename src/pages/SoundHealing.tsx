...
const SoundHealing = () => {
  ...
  return (
    <div className="min-h-screen relative">
      {/* Fixed Blurred Background for Entire Page */}
      <div
      ...
      <div className="relative z-10">
        ...
        {/* Middle Section with Image - With Curves */}
        <div className="relative overflow-visible z-20" style={{ marginTop: "-100px", marginBottom: "-100px" }}>
          {/* Top Curve - Diagonal */}
          <div className="relative w-full overflow-hidden leading-none" style={{ height: "120px" }}>
            <svg className="relative block w-full h-full" preserveAspectRatio="none" viewBox="0 0 1200 120" xmlns="http://www.w3.org/2000/svg">
              <path d="M0,120 L0,0 L1200,60 L1200,120 Z" fill="#856654" />
            </svg>
          </div>

          <div className="relative" style={{ backgroundColor: "#856654" }}>
            {/* Top Corner Text */}
          ...
          {/* Bottom Curve - Diagonal (mirrored) */}
          <div className="relative w-full overflow-hidden leading-none" style={{ height: "120px" }}>
            <svg className="relative block w-full h-full" preserveAspectRatio="none" viewBox="0 0 1200 120" xmlns="http://www.w3.org/2000/svg">
              <path d="M0,0 L0,60 L1200,120 L1200,0 Z" fill="#856654" />
            </svg>
          </div>
        </div>

        {/* Bottom Section - About */}
        <div className="relative py-8 md:py-12" style={{ backgroundColor: "#856654" }}>
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-start">
              ...
              <div className="space-y-5 md:space-y-6 text-white/80 font-sans text-sm md:text-base lg:text-lg leading-relaxed pt-4 md:pt-0">
                ...
                {/* Contact Me Button */}
                <ContactButton serviceName="Sound Healing" className="mt-6" />
              </div>
            </div>
          </div>
        </div>
